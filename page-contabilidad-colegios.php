<?php
/**
 * Template Name: Page Software de Contabilidad
 *
...
<div id="main-page" <?php post_class('main-page'); ?>>
	...
	<section id="<?php echo esc_attr($page_slug); ?>" <?php post_class('hero-page contabilidad d-flex align-items-end'); ?> style="background-image: url(<?php echo $thumb_url[0]; ?>);">
		<article class="wrapp-hero wx-100 mb-5">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<div class="inner-hero"> 					
							<div id="typed-strings"><p>eficiente</p></div>
	...
	<main id="site-main-page" <?php post_class('site-main-page bg--light'); ?>>
		...
		<?php get_template_part('template-parts/content', 'boxes-contabilidad'); ?>
			
		<?php get_template_part('template-parts/content', 'carousel'); ?>

		<?php get_template_part('template-parts/content', 'continuous-update-con'); ?>
