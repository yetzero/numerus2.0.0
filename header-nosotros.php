...
<div id="page" class="site">
	<header id="main-header" class="header-site fixed-top nosotros">
				...
				<button id="toggler-menu" class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#active-menu" aria-controls="active-menu" aria-expanded="false" aria-label="<?php esc_attr_e( 'Toggle navigation', 'numerus' ); ?>">
					...
					<?php
						wp_nav_menu( array(
								...
								'menu_class'        => '',
								'items_wrap'        => '<ul id="%1$s" class="navbar-nav custom-navbar-nav ms-auto mb-2 mb-lg-0 text-sm %2$s">%3$s</ul><ul class="navbar-nav custom-navbar-second ms-2"><li class="nav-item"><a href="https://numerus.cl/inicio-sesion/" class="btn btn-border numerus-white wx-100 px-5"><i class="bi bi-person-circle"></i> login</a></li></ul>',
